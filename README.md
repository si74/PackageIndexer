...
Full honesty - I had little experience with this and engaged in substantial googling. I realized that I could use the python standard socket library and either have multiple threads for concurrent messages along with some sort of queue...or use the existing SocketServer which I decided to go with. 
...
Well, shit. I used the test harness and realized that for synchronous socket server, I kept get incredibly annoying blocks with a larger number of concurrent requests. 
